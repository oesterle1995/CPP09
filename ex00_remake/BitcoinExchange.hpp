...
/*   Updated: 2026/07/27 12:53:50 by aoesterl         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class BitcoinExchange
{
    private :
        ...
        bool parsing_date(const std::string& s1, ptr_ft ft_error, int nb_line);
        bool parsing_value(const std::string& s2, ptr_ft ft_error,\
             int nb_line, bool check_limits = false);
        bool substr_s1_s2(const std::string line, std::string& s1, std::string&s2, char delim);
        bool analyse_line(const std::string& line, map_pair_type& pair, \
    ...
    public:
        ...
        //function
        bool download_price_map(std::ifstream& input_stream);
