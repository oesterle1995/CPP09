...
/*   Updated: 2026/09/03 17:03:42 by aoesterl         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Pmerge
{
    ...
    private :
        ...
        template <typename Container>
        void debug_ford(const Container& tab, const Container& pend, const std::string& title);
...
template <typename Container>
void Pmerge::debug_ford(const Container& tab, const Container& pend, const std::string& title)
{
